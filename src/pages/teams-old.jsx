...
function Teams() {
  ...
  function fetchTeams() {
    ...
    //     headers: {
    //       'x-rapidapi-key':
    //         'bb199be5d2mshdea9eec3806d994p1640d1jsn12f149376f53', process.env.NEXT_PUBLIC_NFL_API_KEY, // next.js env docs - https://nextjs.org/docs/pages/building-your-application/configuring/environment-variables#bundling-environment-variables-for-the-browser
          ...
          {isSuccess && (
            <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8">
              {teams.map(team => (
                <li
                  key={team.id}
                  className="bg-gray-800 rounded-lg py-8 px-6 text-center flex flex-col items-center justify-center shadow-lg shadow-gray-500/25 transform transition-all duration-300 hover:translate-y-[-8px] hover:shadow-lg hover:shadow-gray-500/50 hover:bg-gray-700 focus:translate-y-[-5px] focus:shadow-lg focus:shadow-gray-500/50 focus:bg-gray-700"
                >
                  <img
